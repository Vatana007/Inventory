...
public class AddItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("itemId")) {
            ...
            // ---> NEW: AUTO-GENERATE BARCODE FOR NEW PRODUCTS <---
            // We use System.currentTimeMillis() to generate a unique 13-digit number
            String autoGeneratedBarcode = String.valueOf(System.currentTimeMillis());
            etBarcode.setText(autoGeneratedBarcode);
            // Setting this text automatically triggers your TextWatcher and draws the image!
        }
        ...
        // CASE 2: ADD NEW
            ...
            db.collection("inventory").add(item)
                    .addOnSuccessListener(documentReference -> {
                        ...
                        // ---> NEW: FIREBASE HISTORY LOG FOR ADDING PRODUCT <---
                        Transaction newProductLog = new Transaction("New: " + name, "IN", qty);
                        db.collection("transactions").add(newProductLog);
